...
{
    public partial class Fruits_Vegetables : Form
    {
        ...
        int stockId;
        int SubTotal;
        public Fruits_Vegetables()
        {
            InitializeComponent();
        }

        private void Fruits_Vegetables_Load(object sender, EventArgs e)
        {
            con.Open();
            ...
            con.Open();
            cmd = new SqlCommand("select * from Product where Type='Fruits_Vegetables'",con);
