...
{
    public partial class Dairy_Bakery : Form
    {
        ...
        private void Dairy_Bakery_Load(object sender, EventArgs e)
        {
            con.Open();
            ...
            con.Open();
            cmd = new SqlCommand("select * from Product where Type='Dairy_Bakery'", con);
