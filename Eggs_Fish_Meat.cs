...
{
    public partial class Eggs_Fish_Meat : Form
    {
        ...
        int stockId;
        int SubTotal;
        public Eggs_Fish_Meat()
        {
            InitializeComponent();
        }

        private void Eggs_Fish_Meat_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd = new SqlCommand("select * from Product where Type='Eggs_Fish_Meat'", con);
